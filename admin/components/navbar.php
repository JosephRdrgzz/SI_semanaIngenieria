<div class="nav">
    <div class="container">
        ...
        <div id="nav-links" class="nav-links">
            <a class="btn" href="index.php?view=panel_admin">INICIO</a>
            ...
            <?php if (isset($_SESSION['id_usuario'])): ?>
                <?php if ($_SESSION['tipo_usuario'] === 'admin'): ?>
                    <a class="btn" href="index.php?view=gestionar_eventos">GESTIONAR EVENTOS</a>
                    <a class="btn" href="index.php?view=gestionar_usuarios">GESTIONAR USUARIOS</a>
                <?php else: ?>
