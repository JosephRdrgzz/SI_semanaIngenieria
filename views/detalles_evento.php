...
<div class="container evento-detalles">
    ...
    <div class="evento-header">
        <div class="row">
            <div class="col s12">
                <a href="index.php?view=eventos" class="btn-flat waves-effect">
    ...
    <div class="row">
        <div class="col s12 m8">
            ...
            <div class="info-section">
                ...
                <div class="card-panel">
                    <p><?= htmlspecialchars($evento['comentario']) ?></p>
                </div>
            </div>
        </div>
    ...
    <div class="row evento-actions">
        <div class="col s12 center-align">
            <a id="btn-registrarse" class="btn-large waves-effect waves-light teal" href="#">
